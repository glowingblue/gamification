...
export default class LevelBar extends Component {
    ...
    view() {
        ...
        const pointsText = app.translator.trans('fof-gamification.forum.ranking.level');
        ...
        return isMod ? (
            ...
            <div class="PostUser-level" title={`${expTotal} ${app.translator.trans('fof-gamification.forum.ranking.expText')}`}>
